...
> any MCP-compatible client with one config block. Your agent gets **418 official
...
Current distribution (`_trust_summary`): [90 fresh](badges/status-fresh.svg) · [109 aging](badges/status-aging.svg) · [188 stale](badges/status-stale.svg) · [1 discontinued](badges/status-discontinued.svg) · [2 degraded](badges/status-degraded.svg) · [5 browser-dependent](badges/status-browser-dependent.svg) · [9 unknown-freshness](badges/status-unknown-freshness.svg) · [14 reference](badges/status-reference.svg)
