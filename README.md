...
Current distribution (`_trust_summary`): [94 fresh](badges/status-fresh.svg) · [108 aging](badges/status-aging.svg) · [153 stale](badges/status-stale.svg) · [1 discontinued](badges/status-discontinued.svg) · [1 degraded](badges/status-degraded.svg) · [5 browser-dependent](badges/status-browser-dependent.svg) · [13 reference](badges/status-reference.svg)
