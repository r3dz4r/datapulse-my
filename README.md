...
Current distribution (`_trust_summary`): [65 fresh](badges/status-fresh.svg) · [23 aging](badges/status-aging.svg) · [12 stale](badges/status-stale.svg) · [16 degraded](badges/status-degraded.svg) · [5 browser-dependent](badges/status-browser-dependent.svg) · [1 unreachable](badges/status-unreachable.svg)
