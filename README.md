...
Current distribution (`_trust_summary`): [80 fresh](badges/status-fresh.svg) · [22 aging](badges/status-aging.svg) · [13 stale](badges/status-stale.svg) · [5 browser-dependent](badges/status-browser-dependent.svg) · [1 unreachable](badges/status-unreachable.svg) · [1 unknown-freshness](badges/status-unknown-freshness.svg)
