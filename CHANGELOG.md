...
* **invariants:** scope README-to-health parity to the release path ([#168](https://github.com/r3dz4r/datapulse-my/issues/168)) ([f33c440](https://github.com/r3dz4r/datapulse-my/commit/f33c4401b7ada644b3641c31671c157173ed73c1))

## [3.34.0](https://github.com/r3dz4r/datapulse-my/compare/v3.33.2...v3.34.0) (2026-09-21)


### Features

* **docs:** publish the data collection statement and signal AI-crawler permissions ([#166](https://github.com/r3dz4r/datapulse-my/issues/166)) ([ff0d4db](https://github.com/r3dz4r/datapulse-my/commit/ff0d4db3010cbbbb4339b55caabf010736cb5be2))
...
* **parity:** retry transport failures, never a real server answer ([11438b4](https://github.com/r3dz4r/datapulse-my/commit/11438b407928909573a951202433a3286e8b726b))

## [3.28.0](https://github.com/r3dz4r/datapulse-my/compare/v3.27.0...v3.28.0) (2026-09-19)


### Features

* **observation:** sign through the signer socket by default ([8356839](https://github.com/r3dz4r/datapulse-my/commit/8356839aa040441c6ebefce1560bbd57b26fd4d8))
* **observation:** sign through the signer socket by default ([11fb8b3](https://github.com/r3dz4r/datapulse-my/commit/11fb8b34555e64ea5fd6e836b9058d555c5dfc36))
...
* **deploy:** serve observation receipts from the directory they are written to ([5b27f0e](https://github.com/r3dz4r/datapulse-my/commit/5b27f0eb09e25ecd95b7f95b4efe6de805595d6d))

## [3.24.1](https://github.com/r3dz4r/datapulse-my/compare/v3.24.0...v3.24.1) (2026-09-18)


### Bug Fixes

* **observation:** bind the observation, not the liveness clock ([07040cc](https://github.com/r3dz4r/datapulse-my/commit/07040ccff824f3309d27fbe7f30d4d1eff9b0ae2))
...
* **observation:** print what the payload is, not a captured yes/no ([#93](https://github.com/r3dz4r/datapulse-my/issues/93)) ([5dde114](https://github.com/r3dz4r/datapulse-my/commit/5dde114a228bea1aae5fa08e0617eef8074b4df0))
...
* **attestation:** produce the daily Rekor witness even when the dated set already exists ([ac2cc1e](https://github.com/r3dz4r/datapulse-my/commit/ac2cc1e966f122ff897c021257d17da4e7497db5))

## [3.20.0](https://github.com/r3dz4r/datapulse-my/compare/v3.19.1...v3.20.0) (2026-09-16)
...
* **observation:** record-level counts and incomparability (Task 4.2 part B) ([4315b5a](https://github.com/r3dz4r/datapulse-my/commit/4315b5a2bec73645a8c92f19034f2e0f0e895ac6))
* **observation:** record-level counts and incomparability (Task 4.2 part B) ([044a826](https://github.com/r3dz4r/datapulse-my/commit/044a826597947d0c78a54d1cb9b146f22e2b7875))
...
* **security:** require explicit KV credential injection ([d748ab1](https://github.com/r3dz4r/datapulse-my/commit/d748ab16ffbd27e21c1515ffc8de5553399d8d63))
