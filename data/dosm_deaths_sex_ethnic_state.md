...
The checked resource is 835,505 bytes.
...
- Source: https://api.data.gov.my/data-catalogue?id=deaths_sex_ethnic_state
- [Official catalogue metadata](https://data.gov.my/data-catalogue/deaths_sex_ethnic_state)
...
Refer to the [official catalogue field definitions](https://data.gov.my/data-catalogue/deaths_sex_ethnic_state) before analysis. The machine-readable envelope records fields observed from the source.
...
## Reproducibility
    ...
    curl -sS --max-time 30 "https://api.data.gov.my/data-catalogue?id=deaths_sex_ethnic_state" | head
