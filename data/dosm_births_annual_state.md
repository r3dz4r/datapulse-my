---
dataset_id: dosm_births_annual_state
...
The checked resource is 28,668 bytes.
...
- Source: https://api.data.gov.my/data-catalogue?id=births_annual_state
- [Official catalogue metadata](https://data.gov.my/data-catalogue/births_annual_state)
...
Refer to the [official catalogue field definitions](https://data.gov.my/data-catalogue/births_annual_state) before analysis. The machine-readable envelope records fields observed from the source.
...
## Reproducibility
    ...
    curl -sS --max-time 30 "https://api.data.gov.my/data-catalogue?id=births_annual_state" | head
