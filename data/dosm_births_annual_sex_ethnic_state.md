---
dataset_id: dosm_births_annual_sex_ethnic_state
...
The checked resource is 840,230 bytes.
...
- Source: https://api.data.gov.my/data-catalogue?id=births_annual_sex_ethnic_state
- [Official catalogue metadata](https://data.gov.my/data-catalogue/births_annual_sex_ethnic_state)
...
Refer to the [official catalogue field definitions](https://data.gov.my/data-catalogue/births_annual_sex_ethnic_state) before analysis. The machine-readable envelope records fields observed from the source.
...
## Reproducibility
    ...
    curl -sS --max-time 30 "https://api.data.gov.my/data-catalogue?id=births_annual_sex_ethnic_state" | head
