...
# GTFS Static — BAS.MY Alor Setar Bus Schedule

GTFS Static — BAS.MY Alor Setar Bus Schedule is monitored as a validated GTFS schedule ZIP.

## Provenance

Source URL: `https://api.data.gov.my/gtfs-static/mybas-alor-setar`
...
The sampled ZIP contains 7 routes, 218 stops, 428 trips, and 21,848 stop-time rows.
...
- [samples/gtfs-static/gtfs_static_mybas_alor_setar.zip](../samples/gtfs-static/gtfs_static_mybas_alor_setar.zip)
