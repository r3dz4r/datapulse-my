---
dataset_id: dosm_deaths_district_sex
...
The checked resource is 287,985 bytes.
...
- Source: https://api.data.gov.my/data-catalogue?id=deaths_district_sex
- [Official catalogue metadata](https://data.gov.my/data-catalogue/deaths_district_sex)
...
Refer to the [official catalogue field definitions](https://data.gov.my/data-catalogue/deaths_district_sex) before analysis. The machine-readable envelope records fields observed from the source.
...
## Reproducibility
    ...
    curl -sS --max-time 30 "https://api.data.gov.my/data-catalogue?id=deaths_district_sex" | head
