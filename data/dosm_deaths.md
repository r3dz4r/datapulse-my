...
The checked resource is 1,300 bytes.
...
- Source: https://api.data.gov.my/data-catalogue?id=deaths
- [Official catalogue metadata](https://data.gov.my/data-catalogue/deaths)
...
Refer to the [official catalogue field definitions](https://data.gov.my/data-catalogue/deaths) before analysis. The machine-readable envelope records fields observed from the source.
...
## Reproducibility
    ...
    curl -sS --max-time 30 "https://api.data.gov.my/data-catalogue?id=deaths" | head
