...
source_url: "https://meih.st.gov.my/statistics?_Eng_Statistic_WAR_STOASPublicPortlet__eventId=ViewStatistic&categoryId=10&flowId=37"
source_name: "meih.st.gov.my (ST)"
licence: "Open Government Licence (Malaysia)"
refresh_frequency: "annual"
last_checked: 2026-09-05T06:36:07Z
last_observed: 2011-01-01
last_modified: null
record_count: 11
column_count: 8
status: stale
...
# Electrical Competency Certificates Issued — Malaysia
...
The checked resource is 33,430 bytes.

## Provenance

Suruhanjaya Tenaga (ST) publishes this dataset through meih.st.gov.my:

- `https://meih.st.gov.my/statistics?_Eng_Statistic_WAR_STOASPublicPortlet__eventId=ViewStatistic&categoryId=10&flowId=37`
...
```sh
curl -sS -I "https://meih.st.gov.my/statistics?_Eng_Statistic_WAR_STOASPublicPortlet__eventId=ViewStatistic&categoryId=10&flowId=37"
```
