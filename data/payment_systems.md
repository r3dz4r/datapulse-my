...
source_url: "https://storage.data.gov.my/finsector/payments/systems.csv"
...
The checked resource is 24,268 bytes.
...
The verified CSV contains 4 columns: `date`, `system`, `value`, `volume`.
...
```sh
curl -sS -I "https://storage.data.gov.my/finsector/payments/systems.csv"
curl -sS "https://storage.data.gov.my/finsector/payments/systems.csv" | head -1
```
