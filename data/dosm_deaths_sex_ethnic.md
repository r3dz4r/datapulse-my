---
dataset_id: dosm_deaths_sex_ethnic
...
The checked resource is 49,879 bytes.
...
- Source: https://api.data.gov.my/data-catalogue?id=deaths_sex_ethnic
- [Official catalogue metadata](https://data.gov.my/data-catalogue/deaths_sex_ethnic)
...
Refer to the [official catalogue field definitions](https://data.gov.my/data-catalogue/deaths_sex_ethnic) before analysis. The machine-readable envelope records fields observed from the source.
...
## Reproducibility
    ...
    curl -sS --max-time 30 "https://api.data.gov.my/data-catalogue?id=deaths_sex_ethnic" | head
