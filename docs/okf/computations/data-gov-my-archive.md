...
title: "DataPulse probe family: data_gov_my_archive"
description: "Deterministic DataPulse health probe receipt projection for the data_gov_my_archive family. This date governs the probe method, not data freshness; per-dataset freshness signals live on the Dataset concepts."
status: "stable"
