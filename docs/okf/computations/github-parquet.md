...
description: "Deterministic DataPulse health probe receipt projection for the github_parquet family. This date governs the probe method, not data freshness; per-dataset freshness signals live on the Dataset concepts."
status: "stable"
