...
title: "DataPulse probe family: st_energy_balance"
description: "Deterministic DataPulse health probe receipt projection for the st_energy_balance family. This date governs the probe method, not data freshness; per-dataset freshness signals live on the Dataset concepts."
status: "stable"
