---
type: "Dataset"
title: "Daily JomPAY Transactions"
description: "DataPulse projection of Daily JomPAY Transactions from Payments Network Malaysia and Bank Negara Malaysia."
resource: "https://api.data.gov.my/data-catalogue?id=trnsc_daily_jompay"
...
See the [published health report](/data/trnsc_daily_jompay.md). The probe is described by [the data_gov_my_openapi attested computation](/computations/data-gov-my-openapi.md).
