...
description: "DataPulse projection of Monthly CPI by Subclass from Department of Statistics Malaysia."
resource: "https://storage.dosm.gov.my/cpi/cpi_5d.csv"
...
See the [published health report](/data/cpi_5d.md). The probe is described by [the opendosm_storage attested computation](/computations/opendosm-storage.md).
