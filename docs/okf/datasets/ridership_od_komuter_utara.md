...
KTMB Komuter Utara Origin-Destination Ridership is published by Keretapi Tanah Melayu Berhad and tracked by DataPulse. The latest published probe classifies it as `aging`.
