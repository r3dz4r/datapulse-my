...
description: "DataPulse projection of KTMB Komuter Utara Origin-Destination Ridership from Keretapi Tanah Melayu Berhad."
resource: "https://storage.data.gov.my/transportation/ktmb/komuter_utara_2026.csv"
...
KTMB Komuter Utara Origin-Destination Ridership is published by Keretapi Tanah Melayu Berhad and tracked by DataPulse. The latest published probe classifies it as `fresh`.
...
See the [published health report](/data/ridership_od_komuter_utara.md). The probe is described by [the data_gov_my attested computation](/computations/data-gov-my.md).
