...
datapulse:health_report: "/data/gdp_qtr_nominal.md"
...
OpenDOSM Quarterly Nominal GDP is published by DOSM Malaysia and tracked by DataPulse. The latest published probe classifies it as `fresh`.
...
See the [published health report](/data/gdp_qtr_nominal.md). The probe is described by [the data_gov_my_storage_dosm_gov_my attested computation](/computations/data-gov-my-storage-dosm-gov-my.md).
