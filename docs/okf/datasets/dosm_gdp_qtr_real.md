...
datapulse:health_report: "/data/dosm_gdp_qtr_real.md"
...
See the [published health report](/data/dosm_gdp_qtr_real.md). The probe is described by [the opendosm_storage attested computation](/computations/opendosm-storage.md).
