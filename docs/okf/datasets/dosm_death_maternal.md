...
OpenDOSM Annual Maternal Deaths, Malaysia is published by Department of Statistics Malaysia and tracked by DataPulse. The latest published probe classifies it as `aging`.

# Schema

- `column_count`: `3`
- `first_row_hash`: `shape-v1:1b9077fec809c463e76b03458d254a2c4891a48476aba40d5ee70823b071b5e7`
- `record_count`: `79`
...
See the [published health report](/data/dosm_death_maternal.md). The probe is described by [the opendosm_storage attested computation](/computations/opendosm-storage.md).
