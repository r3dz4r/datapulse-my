...
datapulse:health_report: "/data/population_malaysia.md"
...
See the [published health report](/data/population_malaysia.md). The probe is described by [the data_gov_my_storage_dosm_gov_my attested computation](/computations/data-gov-my-storage-dosm-gov-my.md).
