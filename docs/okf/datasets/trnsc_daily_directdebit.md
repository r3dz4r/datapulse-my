...
Daily DirectDebit Transactions is published by Payments Network Malaysia and Bank Negara Malaysia and tracked by DataPulse. The latest published probe classifies it as `aging`.
