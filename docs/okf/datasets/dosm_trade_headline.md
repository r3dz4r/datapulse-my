...
datapulse:health_report: "/data/dosm_trade_headline.md"
...
OpenDOSM Monthly Trade Headline is published by DOSM Malaysia and tracked by DataPulse. The latest published probe classifies it as `fresh`.
...
See the [published health report](/data/dosm_trade_headline.md). The probe is described by [the opendosm_storage attested computation](/computations/opendosm-storage.md).
