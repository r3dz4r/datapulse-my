---
type: "Dataset"
title: "GTFS Realtime — BAS.MY Melaka Vehicle Positions"
description: "DataPulse projection of GTFS Realtime — BAS.MY Melaka Vehicle Positions from Agensi Pengangkutan Awam Darat (APAD)."
resource: "https://api.data.gov.my/gtfs-realtime/vehicle-position/mybas-melaka"
...
See the [published health report](/data/gtfs_realtime_mybas_melaka.md). The probe is described by [the unclassified attested computation](/computations/unclassified.md).
