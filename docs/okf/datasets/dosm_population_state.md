...
See the [published health report](/data/dosm_population_state.md). The probe is described by [the opendosm_storage attested computation](/computations/opendosm-storage.md).
