...
datapulse:health_report: "/data/dosm_hh_income.md"
...
OpenDOSM Household Income, Malaysia is published by Department of Statistics Malaysia and tracked by DataPulse. The latest published probe classifies it as `fresh`.

# Schema

- `column_count`: `3`
- `first_row_hash`: `shape-v1:ff8432cad1d8778ae9dca8e8421c0014d1aa475b70f46698a62ebe9878bcf7e4`
- `record_count`: `22`
...
See the [published health report](/data/dosm_hh_income.md). The probe is described by [the opendosm_storage attested computation](/computations/opendosm-storage.md).
