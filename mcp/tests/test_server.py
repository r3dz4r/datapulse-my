...
def install_attestation_fixture(monkeypatch: pytest.MonkeyPatch, *, tamper: str | None = None, anchored: bool = True) -> None:
    ...
    registry = {"schema":"datapulse/v2/probe-key-registry","keys":[{"key_id":"ed25519-test","algorithm":"Ed25519","public_key_base64":public64,"not_before":"2026-01-01T00:00:00Z","not_after":"2027-01-01T00:00:00Z","status":"active"}]}
