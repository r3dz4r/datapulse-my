...
PUBLIC_SURFACE_LINKS = {
    ...
    "/agent-workflow-malaysia-public-data.md": ("Malaysia public-data workflow", "Canonical four-call workflow for bounded discovery, verification, and citation."),
    ...
    "/reproducibility.md": ("Reproducibility", "Steps and boundaries for reproducing published artifacts."),
    "/enterprise-governance.md": ("Enterprise governance", "Governance guidance for organizational DataPulse use."),
    "/integration-patterns.md": ("Integration patterns", "Reference patterns for consuming DataPulse public surfaces."),
