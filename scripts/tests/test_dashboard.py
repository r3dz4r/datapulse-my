...
def test_marker_failure_preserves_all_dashboard_targets(tmp_path: Path) -> None:
    ...
    (config / "public-surfaces.json").write_text(json.dumps({
        ...
        "origins": {"website": "https://www.data-pulse.my", "mcp": "https://mcp.data-pulse.my", "repository": "https://github.com/r3dz4r/datapulse-my"},
        "pages": ["/", "/landing.html", "/npra.html", "/health-methodology.html"],
        "artifacts": ["/llms.txt"], "featured_dataset_ids": ["alpha"],
    }) + "\n", encoding="utf-8")
    (config / "public-surfaces.schema.json").write_text(json.dumps({
        "required": ["schema", "product_name", "origins", "pages", "artifacts", "featured_dataset_ids"], "properties": {"product_name": {"const": "DataPulse"}, "origins": {"required": ["website", "mcp", "repository"], "properties": {key: {"const": value} for key, value in {"website": "https://www.data-pulse.my", "mcp": "https://mcp.data-pulse.my", "repository": "https://github.com/r3dz4r/datapulse-my"}.items()}, "additionalProperties": False}}, "additionalProperties": False,
    }) + "\n", encoding="utf-8")
